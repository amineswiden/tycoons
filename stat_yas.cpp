#include "stat_yas.h"
#include <QPainter>
stat_yas::stat_yas(QWidget *parent) : QWidget(parent)
{

}

double stat_yas::total()
{
...
void stat_yas::setData(QVector<double> value, QVector<QColor> color)
{
    qvValue=value;
    qvColor=color;
    repaint();
...
void stat_yas::paintEvent(QPaintEvent *)
